      ...
      context "when created by new" do
        ...
        context "when create query" do
          ...
          it_behaves_like "filter test", described_class,
                          %i[does_not_equal contains does_not_contain starts_with ends_with on_or_before on_or_after],
                          value: "abc"
          it_behaves_like "filter test", described_class, %i[is_empty is_not_empty]
          it_behaves_like "filter test", described_class,
                          %i[past_week past_month past_year next_week next_month next_year], value_str: {}
          it_behaves_like "filter test", described_class,
