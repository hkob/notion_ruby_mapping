...
module NotionRubyMapping
  RSpec.describe Payload do
    ...
    page_discussion_json = tc.read_json "retrieve_comments_top_page"
    h1_block_discussion_json = tc.read_json "retrieve_comments_h1_block"
    ...
    describe "base.comments" do
      ...
      context "dry_run: true" do
        ...
        context "page.comments" do
          ...
          it_behaves_like :dry_run, :get, :retrieve_comments_path, use_id: true
        end
